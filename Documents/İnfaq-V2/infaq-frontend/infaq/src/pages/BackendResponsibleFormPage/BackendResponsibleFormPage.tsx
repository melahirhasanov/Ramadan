// BackendResponsibleFormPage.tsx
...
const BackendResponsibleFormPage: React.FC = () => {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      if (isEdit && id) {
        ...
        toast.success('Səlahiyyətli şəxs yeniləndi');
      } else {
        await personService.create({
          ...
          role: 'backend_responsible',
          profile_image: data.profile_image || ''
        });
        toast.success('Səlahiyyətli şəxs yaradıldı');
      }
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <h1>{isEdit ? 'Səlahiyyətli şəxsi redaktə et' : 'Yeni səlahiyyətli şəxs'}</h1>
...
export default BackendResponsibleFormPage;